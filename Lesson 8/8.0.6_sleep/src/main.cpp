/*
 * This function is used to make the robot move into sleeping positions.
 * 
 * NOTES:
...
// Define a sleep movement array
const int sleepArray[4][9] = {   // there are 4 arrays with 9 columns (adjust the MS value to change the speed)
// URP---URA---LRA---LRP---ULP---ULA---LLA---LLP---MS
  ...
  {100,  132,   50,   78,   75,   45,  120,   92,  2000},  // step 4 - move arms out
};
...
void sleep() {    // Sleep movement positions function
  writeServoPositions(sleepArray, 4);
}
...
// MAIN LOOP
void loop() {
  sleep();    // call sleep positions function
}
 ...
 * - sleepArray has 4 rows and 9 columns
 ...
 * 
 * FUNCTIONS:
 * - sleep() function uses the position arrays to move the limbs
 ...
 * - loop() function calls the sleep() function which runs repeatedly as long as the board is powered on.
 */