...
void MovementDriver::lieDown() {
  startMovementSequence(LIE_DOWN);
}

void MovementDriver::fighting() {
  startMovementSequence(FIGHTING);
}

void MovementDriver::pushUps() {
  startMovementSequence(PUSH_UPS);
}

void MovementDriver::sleep() {
  startMovementSequence(SLEEP);
}
