/*
 * This function is used to make the robot move to center position.
 * 
 * NOTES:
...
// Define a center position array
const int centerArray[1][9] = {    // 1 array with 9 columns (0 to 8)
// URP---URA---LRA---LRP---ULP---ULA---LLA---LLP---MS
  { 90,   92,   90,   78,   90,   85,   80,   92,  500}
};
...
void center() {    // Center position function
  writeServoPositions(centerArray, 1);
}
...
// MAIN LOOP
void loop() {
  center();    // call center position function
}
 ...
 * 
 * ARRAY:
 * - standbyArray and centerArray have 1 row and 9 columns
 ...
 * - loop() function calls the center() function which runs repeatedly as long as the board is powered on.
 */