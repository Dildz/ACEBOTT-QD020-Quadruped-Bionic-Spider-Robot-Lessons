...
const int moveRightArray[5][9] = {   // there are 5 arrays with 9 columns (adjust the MS value to change the speed)
// URP---URA---LRA---LRP---ULP---ULA---LLA---LLP---MS
  {125,  102,   50,   78,   75,   45,  150,  117,  200},  // step 1 - lift URP & LLP (+25) | move URA (-30) & LLA (+30) back
  {100,  102,   50,   53,   50,   45,  150,   92,  200},  // step 2 - drop URP & LLP (-25) | lift ULP & LRP (-25)
  {100,  132,   80,   53,   50,   15,  120,   92,  200},  // step 3 - move URA (+30) & LLA (-30) forward | move ULA (-30) & LRA (+30) forward
  {125,  132,   80,   78,   75,   15,  120,  117,  200},  // step 4 - drop ULP & LRP (+25) | lift URP & LLP (+25)
  {100,  132,   50,   78,   75,   45,  120,   92,  200},  // step 5 - move ULA (+30) & LRA (-30) back | drop URP & LLP (-25)
};
...
void moveRight() {    // Move right function
  writeServoPositions(moveRightArray, 5);    // move through all steps
}
...
// MAIN LOOP
void loop() {
  moveRight();    // call the move right function
  delay(1000);
}
 ...
 * - moveRightArray has 5 rows and 9 columns
 ...
 * 
 * FUNCTIONS:
 * - moveRight() function uses the position arrays to move the limbs
 ...
 * - loop() function calls the moveRight() function which runs repeatedly as long as the board is powered on.
 */