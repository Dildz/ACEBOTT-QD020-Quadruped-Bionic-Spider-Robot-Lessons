/*
 * This function is used to turn the robot left.
 * 
 * NOTES:
...
const int turnLeftArray[9][9] = {    // there are 9 arrays with 9 columns (adjust the MS value to change the speed)
// URP---URA---LRA---LRP---ULP---ULA---LLA---LLP---MS
...
void left() {    // Left function
  writeServoPositions(turnLeftArray, 9);    // move through all 9 steps
}
 ...
 * - loop() function calls the left() function with a 1 second delay which runs repeatedly as long as the board is powered on.
 */
