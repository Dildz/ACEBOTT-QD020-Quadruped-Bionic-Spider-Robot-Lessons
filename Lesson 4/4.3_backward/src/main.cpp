/*
 * This function is used to move the robot backwards.
 * 
 * NOTES:
...
// Define a ready to walk position array (lower the paws to a more stable position)
...
/*
 * LESSONS LEARNED:
 * - To move the robot backward, we use the same code as in lesson 4.2_forward and renamed the function to backward as well as reversing the positions in the backwardArray.
 */
